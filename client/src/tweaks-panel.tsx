...
//
// TODO: replace __edit_mode_set_keys with localStorage persistence in #16.
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function __edit_mode_set_keys(_edits: Record<string, unknown>): void {
  // stub — replaced in #16
}
...
// ── TweaksPanel ─────────────────────────────────────────────────────────────
export const TweaksPanel: React.FC<{ title?: string; children?: React.ReactNode }> = ({
  title = 'Tweaks',
  children,
}) => {
...
export const TweakSection: React.FC<{ label: string; children?: React.ReactNode }> = ({
  label,
  children,
}) => (
  <>
...
export const TweakText: React.FC<TweakTextProps> = ({
  label,
  value,
  placeholder,
  onChange,
...
export const TweakButton: React.FC<TweakButtonProps> = ({
  label,
  onClick,
  secondary = false,
}) => (
