// AbleSet Sync — Lyrics + Leadsheet views, Tweaks UI
      ...
      <section className="setup">
        <div className="setup-header" onClick={() => setSetupOpen(!setupOpen)}>
          ...
          <div style={{display:"flex", alignItems:"center", gap:8}}>
            <span className="meta" style={{color: "var(--fg-3)"}}>ChordPro · {SAMPLE_SONG.lines.length} lines</span>
        ...
        {setupOpen && (
          <div className="setup-body">
            <div className="field">
              ...
              <input className="input" value={songName} onChange={(e) => setSongName(e.target.value)} />
            </div>
            <div className="field">
      ...
      <div className={`workspace${tweaks.logDensity === "spacious" ? " spacious-log" : ""}`}>
        ...
        <div className="viewer">
          ...
          <div className="lyric-progress">
            ...
            <span className="progress-bar"><span className="fill" style={{width: progressPct + "%"}} /></span>
...
function LeadsheetView({ songName, setSongName, page, setPage, stamps, tweaks }) {
...
window.LeadsheetView = LeadsheetView;
